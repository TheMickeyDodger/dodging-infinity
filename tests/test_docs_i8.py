...
I8_DOCS = ("SECURITY.md", "OPERATOR_PROTOCOL.md",
           "CHANGELOG.md", "docs/operations.md")
...
I8_CLAIM_PIN_MAP = (
    # -- docs/operations.md: the observation surface (moved out of README
    # -- byte-for-byte during the README rewrite, and again into the
    # -- consolidated operations page) ---------------------------------------
    ("docs/operations.md", "fact-only",
     "Read this before the architecture, not after it",
     "ClaimPinMapI8Tests.test_every_added_unit_has_a_row"),
    ("docs/operations.md", "doc<->code",
...
class SchemaSurfaceIsProductionsTests(unittest.TestCase):
    ...
    README.md to docs/operations.md during the README
    ...
    def test_readme_top_level_keys_are_the_keys_production_emits(self):
        ...
        block = re.search(
            r"emits them:\s*```text\n(.*?)```",
            doc_text("docs/operations.md"), re.S,
        )
...
class ModelHonestyIsProductionsTests(unittest.TestCase):
    ...
    out of docs/operations.md (the `readme_` methods,
...
class BoundsAreProductionsTests(unittest.TestCase):
    ...
    docs/operations.md (the `readme_` methods keep their
